  ...
  return (
    <>
          ...
          <div className="lg:col-span-7">
            ...
            <Reveal delay={180}>
              <div className="mt-12 max-w-2xl space-y-6 leading-relaxed text-muted-foreground">
                <p>
                  Refill Enterprises Pvt. Ltd. is a nutraceutical company dedicated to
                  serving the growing needs of healthcare professionals and patients
                  with high-quality, science-based products in clinical and critical
                  care nutrition — calcium supplements, amino acid formulations,
                  Omega-3 fatty acids, and specialized metabolic solutions designed to
                  support recovery, rehabilitation, and overall patient well-being.
                </p>
                <p>
                  Beyond nutraceuticals, we introduce advanced medical devices and
                  healthcare applications used exclusively in critical care nutrition
                  and patient management — bridging the gap between modern healthcare
                  technology and patient-centered nutritional care through strategic
                  partnerships.
                </p>
                <p>
                  Next: a sports nutrition portfolio built on the same clinical
                  foundation, and — as our long-term commitment — a state-of-the-art
                  manufacturing facility in Nepal that strengthens domestic healthcare
                  capability, quality assurance, self-reliance, and employment.
                </p>
              </div>
            </Reveal>
          </div>
        ...
        <div className="grid gap-px border border-border bg-border lg:grid-cols-2">
          <div className="bg-background p-8 md:p-14">
            <Reveal>
              ...
              <p className="text-display mt-8 text-balance text-[clamp(1.75rem,3vw,2.75rem)]">
                To become a leading nutraceutical and healthcare solutions company —
                recognized for innovation, quality, and commitment to improving lives
                through advanced nutritional science.
              </p>
            </Reveal>
          </div>
          <div className="bg-background p-8 md:p-14">
          ...
          {values.map((value, i) => (
            <Reveal key={value.title} delay={i * 90} className="bg-background">
              <div className="h-full p-8 md:p-10">
                ...
                <h3 className="text-title mt-6">{value.title}</h3>
      ...
      <Section density="dense">
        <Reveal>
          <StatBlock stats={statistics} className="border border-border" />
        </Reveal>
      </Section>
